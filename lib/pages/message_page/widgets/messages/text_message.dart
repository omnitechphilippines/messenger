...
class TextMessage extends StatefulWidget {
  ...
  const TextMessage({super.key, required this.message, required this.fromFriend});
      ...
      child: Row(
        ...
        children: <Widget>[
          Container(
            ...
            child: Padding(padding: const EdgeInsets.symmetric(vertical: 12.0, horizontal: 16), child: Text(message, style: const TextStyle(color: Colors.white))),
          ),
        ],
      ),
    );
