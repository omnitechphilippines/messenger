...
class GifMessage extends StatefulWidget {
  ...
  const GifMessage({super.key, this.gifUrl, required this.fromFriend, this.gifBytes});
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(color: Colors.white24.withValues(alpha: 0.18)),
              image: fromFriend || gifUrl != null ? DecorationImage(image: NetworkImage(gifUrl!), fit: BoxFit.cover) : DecorationImage(image: MemoryImage(gifBytes!), fit: BoxFit.cover),
