...
class CountDownDialer extends StatefulWidget {
  ...
  @override
  State<CountDownDialer> createState() => _CountDownDialerState();
}

class _CountDownDialerState extends State<CountDownDialer> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final CurvedAnimation curvedAnimation = CurvedAnimation(parent: _controller, curve: widget.curve);
